...
class CylinderEmbedder(nn.Module):
    ...
    def forward(self, pt_fea, xy_ind):
        ...
        _, indices = torch.sort(shuffled_ind)
        ...
        original_order_pts_feature = processed_cat_pt_fea[indices, :]
        ...
        return unq, processed_pooled_data, original_order_pts_feature
