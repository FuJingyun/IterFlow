...
import numpy as np
# sys.path.append('/home/fjy/CMFlow-master/')
...
class MultiScaleEncoder(nn.Module):
    ...
    def forward(self, xyz, features):
        ...
        for i, sa in enumerate(self.ms_ls):
            ...
            # [8, 64, 256] -> [8, 128, 256] -> [8, 192, 256] -> [8, 256, 256]
...
class PointLocalFeature(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        new_points = self.queryandgroup(xyz_t, xyz_t, points)  # torch.Size([8, 6, 256, 16])
...
class FeatureCorrelator(nn.Module):
    ...
    def forward(self, xyz1, xyz2, points1, points2):
        ...
        B, C, N1 = xyz1.shape   # B 3 N
        # _, _, N2 = xyz2.shape
        _, D1, _ = points1.shape  # B 512 N
        # _, D2, _ = points2.shape
        xyz1 = xyz1.permute(0, 2, 1)  # B N 3
        xyz2 = xyz2.permute(0, 2, 1)
        points1 = points1.permute(0, 2, 1) # B N 512
        ...
        # final out new_points: # [B, 512, nsample, N1]

        # weighted sum [B 512 K N]
