...
Constructor which based on a few parameters defines the locations of possible data.
        ...
        self.camera_dir = os.path.join(self.root_dir, 'image_2')
        ...
        self.pose_calib_dir = os.path.join(self.root_dir, 'lidar_calib')

        self.label_dir = os.path.join(self.root_dir, 'label_2_withid')
        self.cmflow_label_dir =  os.path.join(self.root_dir, 'cmflow_lable_withid')
        self.ground_dir =  os.path.join(self.root_dir, 'new_one_frame_radar') 
